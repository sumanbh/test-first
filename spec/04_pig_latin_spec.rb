...
describe "#translate" do
  ...
  it "capitalized words still capitalized with new initial" do
    s = translate("The brown Fox is Smart")
    expect(s).to eq("Ethay ownbray Oxfay isay Artsmay")
  end

# * retain the punctuation from the original phr
  it "retains punctuation from original phrase" do
    s = translate("You know who that is, right?")
    expect(s).to eq("Ouyay owknay owhay atthay isay, ightray?")
  end
